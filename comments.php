...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) { ?>
		...
		<nav id="comment-nav-below" class="comment-navigation clear" role="navigation" aria-label="<?php esc_attr_e( 'Comments', 'simone' ); ?>">
	...
	<?php
		...
		?>
		<h2 class="comments-title"><?php _e( 'Comments', 'simone' ); ?></h2>
		<?php
	}
	// have_comments().
